...
import { mainColors } from '../../Styles/themes';
...
export const CustomCalendarHeader = () => {
    ...
    useEffect(() => {
        if (currentMonth) {
            dispatch(Calendar(currentMonth.format('MMM'), currentMonth.format('YYYY')));
        }
    }, [currentMonth]);
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity onPress={goToPreviousMonth}>
                <Right name="angle-left" color="white" size={20} />
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={goToNextMonth}>
                <Right name="angle-right" color="white" size={20} />
            </TouchableOpacity>
        </View>
    );
};
